...
export default function ProjectCard({ project }: { project: Post<ProjectFrontMatter> }) {
	...
	return (<Link href={`projects/${project.slug}`} className="min-w-0">
		<div className="flex flex-col gap-3.5 rounded-2xl bg-surface shadow-line border-l-3 border-olive p-6.5 cursor-pointer transition-[background,transform] duration-200 ease hover:bg-surface2 hover:-translate-y-0.75">
